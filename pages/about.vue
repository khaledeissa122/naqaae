            ...
            <div class="about-us__body">
              ...
              <div class="about-us__text typography">
                <p>
                  ...
                  lacus metus, convallis ut leo nec, tincidunt eleifend justo.
                  Ut felis orci, hendrerit a pulvinar et, gravida ac lorem. Sed
                  vitae molestie sapien, at sollicitudin tortor.
                </p>
                <p>
              ...
              <div class="about-us__team">
                ...
                <div class="about-us__team-subtitle text-muted">
                  Want to work in our friendly team?<br /><a
                ...
                <div class="about-us__teammates teammates">
                  <carousel :nav="false" :items="3" :dots="false">
                    <div v-for="(n, i) in 3" :key="i" class="mx-1">
                      <div class="teammates__item teammate">
                        <div class="teammate__avatar">
                          <img src="/teammates/teammate-1.jpg" alt="" />
                        </div>
