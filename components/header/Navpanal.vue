          ...
          <div class="nav-panel__departments">
            ...
            <div
              :class="[
                'departments',
                {
                  'departments--opened departments--fixed':
                    $route.name == 'index'
                }
              ]"
              :data-departments-fixed-by="`${$route.name == 'index'?'.block__slideshow':''}`"
            >
                  ...
                  <ul class="departments__links">
                    <li class="departments__item">
                      <a href="#"
                        ...
                        >
                          <use
                            xlink:href="/sprite.svg#arrow-rounded-right-6x9"
                          ></use></svg
                      ></a>
                      <div
                      ...
                      >
                        ...
                        <div
                          ...
                          style="
                                                                        background-image: url('/megamenu/megamenu-1.jpg');
                                                                    "
                        >
                          <div class="row">
                            <div class="col-3">
                    ...
                    <li class="departments__item">
                      ...
                      >
                        ...
                        <div
                          class="megamenu megamenu--departments"
                          style="
                                                                        background-image: url('/megamenu/megamenu-2.jpg');
                                                                    "
                        >
                          <div class="row">
                            <div class="col-4">
              ...
              <button class="departments__button">
                <svg
                  ...
                  height="14px"
                >
                  <use xlink:href="/sprite.svg#menu-18x14"></use>
                </svg>
                Shop By Category
                <svg class="departments__button-arrow" width="9px" height="6px">
                  <use xlink:href="/sprite.svg#arrow-rounded-down-9x6"></use>
                </svg>
              </button>
            </div>
            <!-- .departments / end -->
                ...
                <a href="index.html"
                  ><span
                    ...
                    <svg class="nav-links__arrow" width="9px" height="6px">
                      <use
                        xlink:href="/sprite.svg#arrow-rounded-down-9x6"
                      ></use></svg></span
                ></a>
          ...
          <div class="nav-panel__indicators">
              ...
              <a href="wishlist.html" class="indicator__button"
                ><span class="indicator__area"
                  ><svg width="20px" height="20px">
                    <use xlink:href="/sprite.svg#heart-20"></use>
                  </svg>
            ...
            <div class="indicator indicator--trigger--click">
              <a href="cart.html" class="indicator__button"
                ><span class="indicator__area"
                  ><svg width="20px" height="20px">
                    <use xlink:href="/sprite.svg#cart-20"></use>
                  </svg>
                    ...
                    <div class="dropcart__product">
                      ...
                      >
                        <svg width="10px" height="10px">
                          <use xlink:href="/sprite.svg#cross-10"></use>
                        </svg>
                      </button>
                    </div>
                    <div class="dropcart__product">
