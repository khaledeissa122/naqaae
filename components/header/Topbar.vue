        ...
        <div class="topbar__container container">
          <div class="topbar__row">
            <div class="topbar__item topbar__item--link">
              ...
              <nuxt-link class="topbar-link" to="about">About Us</nuxt-link>
            </div>
            <div class="topbar__item topbar__item--link">
              ...
              <div class="topbar-dropdown">
                <button class="topbar-dropdown__btn" type="button">
                  ...
                  <svg width="7px" height="5px">
                    <use xlink:href="/sprite.svg#arrow-rounded-down-7x5"></use>
                  </svg>
                </button>
              ...
              <div class="topbar-dropdown">
                ...
                <div class="topbar-dropdown__body">
                  ...
                  <ul class="menu menu--layout--topbar menu--with-icons">
                    <li  @click="changeLang('ltr')">
                      <a href="#"
                        ><div class="menu__icon">
                          <img
                            srcset="
                              /languages/language-1.png,
                              /languages/language-1@2x.png 2x
                            "
                            src="/languages/language-1.png"
                            alt=""
                          />
                        </div>
                        English</a
                    ...
                    <li @click="changeLang('rtl')">
                      <a href="#"
                        ><div class="menu__icon">
                          <img
                            srcset="
                              /languages/egypt.png,
                              /languages/egypt-2@2x.png 2x
                            "
                            src="/languages/egypt.png"
                            alt=""
                          />
                        </div>
                        عربي</a
            ...
            <form class="search__form" action="#">
              ...
              <button class="search__button" type="submit">
                <svg width="20px" height="20px">
                  <use xlink:href="/sprite.svg#search-20"></use>
                </svg>
              </button>
...
<script>
import Navpanal from "~/components/header/Navpanal.vue";
export default {
  components: {
    Navpanal
  },
