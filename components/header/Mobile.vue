              ...
              <div class="mobile-links__item-title">
                ...
                >
                  <svg
                    ...
                    height="7px"
                  >
                    <use xlink:href="/sprite.svg#arrow-rounded-down-12x7"></use>
                  </svg>
                </button>
              </div>
                  ...
                  <li class="mobile-links__item" data-collapse-item>
                    <div class="mobile-links__item-title">
                      ...
                      >
                        ...
                        >
                          <use
                            xlink:href="/sprite.svg#arrow-rounded-down-12x7"
                          ></use>
                        </svg>
                      </button>
                    </div>
            ...
            <li class="mobile-links__item" data-collapse-item>
              ...
              <div class="mobile-links__item-sub-links" data-collapse-content>
                <ul class="mobile-links mobile-links--level--1">
                  <li class="mobile-links__item" data-collapse-item>
                    <div class="mobile-links__item-title">
                      <a href="about-us.html" class="mobile-links__item-link"
                        >About Us</a
                      >
                    </div>
                  </li>
            ...
            <li class="mobile-links__item" data-collapse-item>
              ...
              <div class="mobile-links__item-sub-links" data-collapse-content>
                <ul class="mobile-links mobile-links--level--1">
                  ...
                  <li
                    @click="changeLang('rtl')"
                    class="mobile-links__item"
                    data-collapse-item
                  >
                    <div class="mobile-links__item-title">
                      <a href="#" class="mobile-links__item-link">عربي</a>
                    </div>
                  </li>
                </ul>
              </div>
